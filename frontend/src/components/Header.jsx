...
const Header = () => {
  ...
  useEffect(()=>{
    ...
    //clean up the event lister when component unmounts
    return () =>{
  ...
  return (
    <header className={`${active ? "py-1 bg-white shadow-md": "py-2"} py-2 max-padd-container fixed top-0 w-full left-0 right-0 z-50 transition-all duration-200`}>
      {/*CONTAINER*/}
      <div className="flexBetween">
        ...
        {/* BUTTONS */}
        <div className="flex items-center gap-x-7 sm:gap-x-2 bold-16">
        {!menuOpened ? (
        ...
        <button className="flexCenter items-center gap-x-2 px-5 btn-dark">
